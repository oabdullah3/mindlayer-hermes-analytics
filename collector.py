...
# ──────────────────────────────────────────────────────────────────────────────
# Step 8: Global Insights (Tasks 9.1 – 9.3)
# ──────────────────────────────────────────────────────────────────────────────
...
def try_remote_push(snapshot: dict, remote_url: str) -> bool:
    """
...
def collect(hermes_home: str | None = None) -> dict:
    ...
    try:
        ...
        for session in sessions:
            ...
            session["chat_name"] = None  # not available in state.db
            session["tokens"] = {
    ...
    return assemble_snapshot(hermes_home, sessions, global_insights)
...
def main() -> None:
    ...
    if remote_url:
        ...
        success = try_remote_push(snapshot, remote_url)
        if success:
            print(
