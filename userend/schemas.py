...
HERMES_SNAPSHOT_ANALYTICS = {
    ...
    "parameters": {
        ...
        "properties": {
            "mode": {
                "type": "string",
                "enum": ["cli", "browser", "both"],
                "description": "Output mode: cli (terminal, default), browser (Streamlit), or both",
            },
            "fallback": {
                "type": "boolean",
                "description": "If the chosen mode fails, automatically try the other mode",
            },
            "server_port": {
                "type": "integer",
