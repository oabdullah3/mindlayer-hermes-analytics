...
- [x] 8.1 Re-run collector: verify `chat_name` is populated, `tool_calls` has correct names, no "unknown" tools
- [x] 8.2 Launch dashboard and visually verify all 5 pages: no truncation, bar gaps, legend positions, pie colors, dropdown labels, message containers
- [x] 8.3 Run full test suite (42 tests) — update test expectations if collector output changed
